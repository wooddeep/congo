 ...
 */
public class ReplSetGetStatus {

    @SubCommand(name = "replSetGetStatus")
    public static SubCmdItf replSetGetStatus = (Vertx vertx, MongoBody body, MongoHead head, NetSocket socket) -> {
